      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Let's discuss how Apex Strategic Solutions can help accelerate your growth, optimize operations, 
            and achieve sustainable competitive advantage. Schedule your strategic consultation today.
          </p>
        </div>
      </div>
    </section>
