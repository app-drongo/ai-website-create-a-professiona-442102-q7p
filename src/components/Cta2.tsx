...
import { ArrowRight, Phone, MessageSquare, Calendar, Award } from "lucide-react"

export default function Cta2() {
  const stats = [
    { value: "500+", label: "Clients Served", icon: Award },
    { value: "98%", label: "Client Retention", icon: MessageSquare },
    { value: "24hr", label: "Response Time", icon: Phone },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                ...
                and craft tailored solutions that drive measurable business results.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Speak directly with senior consultants, no intermediaries
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Quick turnaround on inquiries and project proposals
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Book consultations at your convenience, including evenings
              </p>
            </div>
          </div>
        </div>
